...
sealed class SystemMaterialsLabelsTextColors {
  const SystemMaterialsLabelsTextColors({
    ...
    required this.vibrantTertiary,
    required this.vibrantQuartenary,
  });

  final Color vibrantPrimary;
  final Color vibrantSecondary;
  final Color vibrantTertiary; // Mantido o nome original (possível typo)
  ...
  SystemMaterialsLabelsTextColors lerp(
    ...
    return instance.copyWith(
      ...
      vibrantTertiary: Color.lerp(vibrantTertiary, b.vibrantTertiary, t),
...
final class SystemMaterialsLabelsTextColorsLight
  ...
  const SystemMaterialsLabelsTextColorsLight({
    ...
    Color? vibrantQuartenary,
         ...
         vibrantTertiary: vibrantTertiary ?? const Color.fromRGBO(0, 0, 0, .3),
         vibrantQuartenary:
  ...
  SystemMaterialsLabelsTextColors copyWith({
    ...
    vibrantTertiary: vibrantTertiary,
...
final class SystemMaterialsLabelsTextColorsDark
  ...
  const SystemMaterialsLabelsTextColorsDark({
    ...
    Color? vibrantQuartenary,
         ...
         vibrantTertiary:
             vibrantTertiary ?? const Color.fromRGBO(255, 255, 255, .3),
         vibrantQuartenary:
...
sealed class SystemMaterialsFillColors {
  ...
  SystemMaterialsFillColors lerp(SystemMaterialsFillColors b, double t) {
    if (identical(this, b)) {
      return this;
    }
    final instance = t < 0.5 ? this : b;
...
sealed class SystemMaterialsSeparatorColors {
  const SystemMaterialsSeparatorColors({required this.separator});
  ...
  SystemMaterialsSeparatorColors lerp(
    ...
    final instance = t < 0.5 ? this : b;
    return instance.copyWith(separator: Color.lerp(separator, b.separator, t));
  }

  SystemMaterialsSeparatorColors copyWith({Color? separator});
}

final class SystemMaterialsSeparatorColorsLight
    extends SystemMaterialsSeparatorColors {
  const SystemMaterialsSeparatorColorsLight({Color? separator})
    : super(separator: separator ?? const Color.fromRGBO(0, 0, 0, .3));

  @override
  SystemMaterialsSeparatorColors copyWith({Color? separator}) =>
      SystemMaterialsSeparatorColorsLight(separator: separator);
}

final class SystemMaterialsSeparatorColorsDark
    extends SystemMaterialsSeparatorColors {
  const SystemMaterialsSeparatorColorsDark({Color? separator})
    : super(separator: separator ?? const Color.fromRGBO(255, 255, 255, .3));

  @override
  SystemMaterialsSeparatorColors copyWith({Color? separator}) =>
      SystemMaterialsSeparatorColorsDark(separator: separator);
}
