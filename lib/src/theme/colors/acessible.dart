...
final class AccessibleColorsLight extends AccessibleColors {
  const AccessibleColorsLight()
      : super(
...
final class AccessibleColorsDark extends AccessibleColors {
  const AccessibleColorsDark()
      : super(
